...
import {
  getUpcomingMasses,
} from '../services/UpcomingMassesApi';
      ...
      if (
        ...
        throw new Error(
          (
            ...
            'para ordenar as missas por proximidade.'
          )
        );
      }
    ...
    if (
      ...
      return (
        <Text style={styles.endText}>
          Todas as missas foram carregadas.
        </Text>
      );
    }
